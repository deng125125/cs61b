...
public class WorldGenerator {
    public static final int MAXROOM = 30;
    ...
    public static ArrayList<Room> drawRoom(TETile[][] tiles, int roomNumber, WorldGenerateParam wgp) {
        ...
        for (int i = 0; i < roomNumber; i += 1) {
            ...
            if (newRoom.isCrossWithRoomList(roomList)) {
                i -= 1;
                continue;
            }
            Room.addRoom(tiles, startP, roomWidth, roomHeight);  // draw the room
